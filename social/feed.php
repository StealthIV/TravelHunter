<?php
  ...
  if (isset($_SESSION['UserName'])) {
      ...
      try {
          ...
          $stmt = $pdo->prepare("SELECT FullName, image FROM user WHERE id = :user_id");
          ...
          if ($user) {
              ...
              $first_name = "UserName";
              $last_name = "";
              $profile_image = "img/default_profile.jpg"; // Default image path if profile_image is not set
          }
                ...
                <?php foreach ($posts as $post): ?>
                    <div class="post">
                        <div id="profile">
                            ...
                            <img id="profile_img" src="<?php echo htmlspecialchars($post['profile_image']); ?>"
                                alt="Profile Picture">
                            <h3><?php echo htmlspecialchars($post['firstname'] . ' ' . $post['lastname']);
                            ?></h3>
                        ...
                        <div class="post-actions">
                            ...
                            <div class="comments-container" style="display: none;">
                                ...
                                $stmt = $pdo->prepare("
            SELECT comments.*, user.firstname, user.lastname, user.profile_image 
            FROM comments 
        ...
        ");
                                ...
                                if (!empty($comments)) {
                                    foreach ($comments as $comment) {
                                        ...
                                        echo '<img src="' . htmlspecialchars($comment['profile_image']) . '" alt="Profile Picture" class="comment-profile-img">'; // Profile image
